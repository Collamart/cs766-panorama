...
imgs = loadImages(imgFiles);
newImg = createPanoramaCyl(imgs, 575, -0.15, 0, true, false, 'Alpha');
figure;
imshow(newImg);
...
imgFiles = {'TestImages/BascomTest1-1.jpg', 'TestImages/BascomTest1-2.jpg',...
    ...
    'TestImages/BascomTest1-11.jpg', 'TestImages/BascomTest1-12.jpg'};
imgs = loadImages(imgFiles);
newImg = createPanoramaCyl(imgs, 575, -0.15, 0, true, false, 'Pyramid');
figure;
imshow(newImg);

%% Bascom Final
imgFiles = {'TestImages/Bascom1-1.jpg', 'TestImages/Bascom1-2.jpg',...
    'TestImages/Bascom1-3.jpg', 'TestImages/Bascom1-4.jpg',...
    'TestImages/Bascom1-5.jpg', 'TestImages/Bascom1-6.jpg',...
    'TestImages/Bascom1-7.jpg', 'TestImages/Bascom1-8.jpg',...
    'TestImages/Bascom1-9.jpg', 'TestImages/Bascom1-10.jpg',...
    'TestImages/Bascom1-11.jpg', 'TestImages/Bascom1-12.jpg'};
imgs = loadImages(imgFiles);
newImg = createPanoramaCyl(imgs, 2380, -0.17, 0.2, true, false, 'Pyramid');
figure;
imshow(newImg);